...
def run_query(search_terms):
	...
	# Wrap quotes around our query terms as reqired by the Bing API.
	# The query e will then use is stored within the variable query. 
	...
	try: 
		...
		# Connect to the server and red the response generated 
